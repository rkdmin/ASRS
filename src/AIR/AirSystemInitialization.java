              ...
              " DROP TABLE IF EXISTS  air.Tour ;",
               " CREATE TABLE Tour( " +
                 ...
                 " DROP TABLE IF EXISTS  air.Route ;",
                  ...
                  "insert Route values('인천-오사카',15772600,570073200,'인천공항','12:30','간사이공항','13:40','20220502',519000);" ,
                  "insert Route values('오사카-인천',570073200,15772600,'간사이공항','14:00','인천공항','15:10','20220503',449000);" ,
                  "insert Route values('인천-제주',15772600,647972526,'인천공항','12:00','제주공항','12:55','20220502',171000);" ,
                  "insert Route values('제주-인천',647972526,15772600,'제주공항','15:00','인천공항','15:55','20220503',124000);" ,
                  "insert Route values('인천-뉴욕',15772600,718244444,'인천공항','08:30','존케네디공항','23:30','20220503',4225000);" ,
                  "insert Route values('뉴욕-인천',718244444,15772600,'존케네디공항','07:00','인천공항','22:00','20220504',4127000);" ,
                  "insert Route values('인천-괌',15772600,671642321,'인천공항','10:20','앤토니오B.원팻 공항','19:40','20220504',686100);" ,
                  "insert Route values('괌-인천',671642321,15772600,'앤토니오B.원팻 공항','11:00','인천공항','20:20','20220505',575400);" ,
                  "insert Route values('인천-파리',15772600,3950,'인천공항','16:00','샤를드골공항','08:30','20220503',3430000);" ,
                  "insert Route values('파리-인천',3950,15772600,'샤를드골공항','08:00','인천공항','00:30','20220507',3152000);" };
